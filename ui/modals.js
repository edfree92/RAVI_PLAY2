...
function _spinRoulette() {
  ...
  const chosenA  = _getNextPlayer("A");
  const chosenB  = _getNextPlayer("B");
...
document.getElementById("roulettePlayBtn").addEventListener("click", _spinRoulette);

document.getElementById("rouletteContinueBtn").addEventListener("click", function () {
